...
import { CustomerSnapshotClient } from '@/components/tables/customer-smnapshot-tables/client';
...
export default function SnapshotReportPage() {
  return (
    <MainLayout meta={{ title: 'Customer Snapshot report' }}>
      <div className="flex-1 space-y-4 min-h-screen p-4 pt-6 md:p-8">
        <BreadCrumb items={breadcrumbItems} />
        <CustomerSnapshotClient/>
      </div>
    </MainLayout>
  );
}